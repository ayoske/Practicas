...
// -----  CLASE 23  MODULOS TYPESCRIPT   --------------
// Sirven para cargar archivos que esten segmentados a lo largo del programa, con un archivo

// utilizando export al crear una clase, en el archivo js donde se utilizará escriba
//misma clase con import {<nombre de clase>} from <direccion de archivo clase>
// y despues crear la instancia con esa misma clase.

// para no utilizar import por cada clase en cada archivo que se necesite se
//crea un archivo index.ts donde se importan todas las clases con sus respectivas
// direcciones, asi al utilizarla en tu app.js solo se utilizará un import
//Ej. import {Villano, Xmen} from "./clases.index";

// -----  CLASE 24  MODULOS TYPESCRIPT   --------------
